      ...
      >
        ...
        <div className="flex items-center justify-end px-4 pt-4 pb-2">
          <button
            ...
            className="px-3 py-3 my-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-gray-300 hover:bg-gray-700/50 hover:text-white transition-colors flex items-center gap-2 text-sm"
          >
            <Plus className="w-4 h-4" />
