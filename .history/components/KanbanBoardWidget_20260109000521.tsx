  ...
  return (
    <div className="h-full flex flex-col bg-gray-900/50">
      ...
      >
        ...
        <div className="flex items-center px-4 pt-4 pb-2 w-full">
          <button
            onClick={handleAddColumn}
            className="ml-auto px-3 py-4 bg-gray-800/50 border border-gray-700/50 rounded-lg text-gray-300 hover:bg-gray-700/50 hover:text-white transition-colors flex items-center gap-2 text-sm"
            style={{ marginTop: '8px', marginBottom: '8px', height: '40px', float: 'right' }}
          >
            <Plus className="w-4 h-4" />
        ...
        <div className="flex-1 overflow-x-auto px-4 pb-4">
          <div className="flex gap-4 h-full w-full" style={{ paddingBottom: '8px' }}>
            {columns.map((column) => (
