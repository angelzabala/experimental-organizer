...
export default function Home() {
  ...
  }, [workspaces.length, activeWorkspaceId, addWorkspace, setActiveWorkspace]);
  ...
  return (
    <main className="relative w-screen h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      {/* Desktop Background */}
