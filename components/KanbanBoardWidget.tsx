      ...
      >
        ...
        <div className="flex items-center justify-end px-4 pt-4 pb-2 w-full">
          <button
            ...
            className="px-3 py-4 bg-gray-800/50 border border-gray-700/50 rounded-lg text-gray-300 hover:bg-gray-700/50 hover:text-white transition-colors flex items-center gap-2 text-sm"
